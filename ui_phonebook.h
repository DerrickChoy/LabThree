...
"color: rgb(255, 255, 255);"));
        ...
        eightPushButton->raise();
        sevenPushButton->raise();
        ninePushButton->raise();
        twoPushButton->raise();
        sixPushButton->raise();
        fivePushButton->raise();
        onePushButton->raise();
        zeroPushButton->raise();
        threePushButton_11->raise();
        threePushButton_12->raise();
        dialerDisplay->raise();
        deleteButton->raise();
        line_2->raise();
